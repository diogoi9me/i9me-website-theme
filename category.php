...
?>
	<div class="banner-single" <?php // echo $bg_banner_single; ?>>
		<header class="banner-single__header">
			...
			<h2 class="banner-single__title"><?php echo single_cat_title(); ?></h2>
			<p class="banner-single__subtitle"><?php echo category_description() ?></p>
		</header>
	</div>
...
<article class="page-blog">
	<section class="blog padding-bottom">
		<header class="blog__header">
			<h2 class="blog__header-title">Artigos da Categoria</h2>
		</header>
		<div class="container">
				...
				?> 
          		...
          		<?php } else { ?>
          			<li class="no-posts padding-horizontal padding-vertical align-center">
          				<h3>Não há nenhum artigo dentro dessa categoria.</h3>
          			</li>
          		<?php } ?>     
    		</ul>
