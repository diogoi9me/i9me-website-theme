! function(e, t) {
    ...
    function u(e, t, n, i) {
        if (je(e)) {
            var o, r, s = pe.expando,
                ...
                l = a ? pe.cache : e,
                c = a ? e[s] : e[s] && s;
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof t) return c || (c = a ? e[s] = ne.pop() || pe.guid++ : s), l[c] || (l[c] = a ? {} : {
                toJSON: pe.noop
            }), ("object" == typeof t || "function" == typeof t) && (i ? l[c] = pe.extend(l[c], t) : l[c].data = pe.extend(l[c].data, t)), r = l[c], i || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[pe.camelCase(t)] = n), "string" == typeof t ? (o = r[t], null == o && (o = r[pe.camelCase(t)])) : o = r, o
        }
    }
        ...
        if (je(e)) {
            ...
            if (s[a]) {
                if (t && (i = n ? s[a] : s[a].data)) {
                    pe.isArray(t) ? t = t.concat(pe.map(t, pe.camelCase)) : t in i ? t = [t] : (t = pe.camelCase(t), t = t in i ? [t] : t.split(" ")), o = t.length;
                    for (; o--;) delete i[t[o]];
                    if (n ? !c(i) : !pe.isEmptyObject(i)) return
                }(n || (delete s[a].data, c(s[a]))) && (r ? pe.cleanData([e], !0) : de.deleteExpando || s != s.window ? delete s[a] : s[a] = void 0)
            }
        }
    }
    ...
    function h(e, t, n, i) {
        ...
        if (u && u[3] !== c) {
            c = c || u[3], n = n || [], u = +l || 1;
            do r = r || ".5", u /= r, pe.style(e, t, u + c); while (r !== (r = a() / l) && 1 !== r && --s)
        }
    ...
    function f(e, t) {
        ...
        if (!r)
            for (r = [], n = e.childNodes || e; null != (i = n[o]); o++) !t || pe.nodeName(i, t) ? r.push(i) : pe.merge(r, f(i, t));
    ...
    function v(e, t, n, i, o) {
        for (var r, s, a, l, c, u, d, h = e.length, v = p(t), y = [], w = 0; h > w; w++)
            if (s = e[w], s || 0 === s)
                if ("object" === pe.type(s)) pe.merge(y, s.nodeType ? [s] : s);
                else if (Ve.test(s)) {
            for (l = l || v.appendChild(t.createElement("div")), c = (Re.exec(s) || ["", ""])[1].toLowerCase(), d = Xe[c] || Xe._default, l.innerHTML = d[1] + pe.htmlPrefilter(s) + d[2], r = d[0]; r--;) l = l.lastChild;
            if (!de.leadingWhitespace && Fe.test(s) && y.push(t.createTextNode(Fe.exec(s)[0])), !de.tbody)
                for (s = "table" !== c || Ue.test(s) ? "<table>" !== d[1] || Ue.test(s) ? 0 : l : l.firstChild, r = s && s.childNodes.length; r--;) pe.nodeName(u = s.childNodes[r], "tbody") && !u.childNodes.length && s.removeChild(u);
            for (pe.merge(y, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
            l = v.lastChild
        } else y.push(t.createTextNode(s));
        for (l && v.removeChild(l), de.appendChecked || pe.grep(f(y, "input"), m), w = 0; s = y[w++];)
            if (i && pe.inArray(s, i) > -1) o && o.push(s);
            else if (a = pe.contains(s.ownerDocument, s), l = f(v.appendChild(s), "script"), a && g(l), n)
    ...
    function k(e, t) {
        if (1 === t.nodeType && pe.hasData(e)) {
            ...
            if (a) {
                ...
                for (n in a)
                    for (i = 0, o = a[n].length; o > i; i++) pe.event.add(t, n, a[n][i])
            }
    ...
    function S(e, t, n, i) {
        ...
        var o, r, s, a, l, c, u = 0,
            ...
            p = t[0],
            g = pe.isFunction(p);
        if (g || d > 1 && "string" == typeof p && !de.checkClone && it.test(p)) return e.each(function(o) {
            var r = e.eq(o);
            g && (t[0] = p.call(this, o, r.html())), S(r, t, n, i)
        });
        if (d && (c = v(t, e[0].ownerDocument, !1, e, i), o = c.firstChild, 1 === c.childNodes.length && (c = o), o || i)) {
            for (a = pe.map(f(c, "script"), _), s = a.length; d > u; u++) r = c, u !== h && (r = pe.clone(r, !0, !0), s && pe.merge(a, f(r, "script"))), n.call(e[u], r, u);
            if (s)
                for (l = a[a.length - 1].ownerDocument, pe.map(a, T), u = 0; s > u; u++) r = a[u], qe.test(r.type || "") && !pe._data(r, "globalEval") && pe.contains(l, r) && (r.src ? pe._evalUrl && pe._evalUrl(r.src) : pe.globalEval((r.text || r.textContent || r.innerHTML || "").replace(rt, "")));
            c = o = null
        }
        return e
    }
    ...
    function A(e, t, n) {
        for (var i, o = t ? pe.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || pe.cleanData(f(i)), i.parentNode && (n && pe.contains(i.ownerDocument, i) && g(f(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    ...
    function D(e) {
        var t = ie,
            n = ct[e];
        return n || (n = N(e, t), "none" !== n && n || (lt = (lt || pe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (lt[0].contentWindow || lt[0].contentDocument).document, t.write(), t.close(), n = N(e, t), lt.detach()), ct[e] = n), n
    }
    ...
    function j(e) {
        ...
        for (var t = e.charAt(0).toUpperCase() + e.slice(1), n = _t.length; n--;)
            if (e = _t[n] + t, e in Tt) return e
    }

    function M(e, t) {
        for (var n, i, o, r = [], s = 0, a = e.length; a > s; s++) i = e[s], i.style && (r[s] = pe._data(i, "olddisplay"), n = i.style.display, t ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && $e(i) && (r[s] = pe._data(i, "olddisplay", D(i.nodeName)))) : (o = $e(i), (n && "none" !== n || !o) && pe._data(i, "olddisplay", o ? n : pe.css(i, "display"))));
    ...
    function O(e, t, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += pe.css(e, n + Ie[r], !0, o)), i ? ("content" === n && (s -= pe.css(e, "padding" + Ie[r], !0, o)), "margin" !== n && (s -= pe.css(e, "border" + Ie[r] + "Width", !0, o))) : (s += pe.css(e, "padding" + Ie[r], !0, o), "padding" !== n && (s += pe.css(e, "border" + Ie[r] + "Width", !0, o)));
        return s
    }
    ...
    function R(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = pe.css(e, "display"), u = "none" === c ? pe._data(e, "olddisplay") || D(e.nodeName) : c, "inline" === u && "none" === pe.css(e, "float") && (de.inlineBlockNeedsLayout && "inline" !== D(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", de.shrinkWrapBlocks() || d.always(function() {
        ...
        if (pe.isEmptyObject(h)) "inline" === ("none" === c ? D(e.nodeName) : c) && (p.display = c);
        else {
            g ? "hidden" in g && (f = g.hidden) : g = pe._data(e, "fxshow", {}), r && (g.hidden = !f), f ? pe(e).show() : d.done(function() {
                pe(e).hide()
            }), d.done(function() {
                var t;
            ...
            for (i in h) s = W(f ? g[i] : 0, i, d), i in g || (g[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function F(e, t, n) {
        var i, o, r = 0,
            ...
            l = function() {
                if (o) return !1;
                for (var t = kt || $(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++) c.tweens[s].run(r);
        ...
        for (q(u, c.opts.specialEasing); s > r; r++)
            if (i = F.prefilters[r].call(c, e, u, c.opts)) return pe.isFunction(i.stop) && (pe._queueHooks(c.elem, c.opts.queue).stop = pe.proxy(i.stop, i)), i;
        return pe.map(u, W, c), pe.isFunction(c.opts.start) && c.opts.start.call(e, c), pe.fx.timer(pe.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    function G(e, t, n, i) {
        ...
        if (pe.isArray(t)) pe.each(t, function(t, o) {
            n || nn.test(e) ? i(e, o) : G(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, i)
        });
    ...
    pe.fn = pe.prototype = {
        ...
        var e, t, n, i, o, r, s = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || pe.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)
            if (null != (o = arguments[a]))
                for (i in o) e = s[i], n = o[i], s !== n && (c && n && (pe.isPlainObject(n) || (t = pe.isArray(n))) ? (t ? (t = !1, r = e && pe.isArray(e) ? e : []) : r = e && pe.isPlainObject(e) ? e : {}, s[i] = pe.extend(c, r, n)) : void 0 !== n && (s[i] = n));
        return s
    }, pe.extend({
    ...
    var ye = function(e) {
        function t(e, t, n, i) {
            var o, r, s, a, l, c, d, p, f = t && t.ownerDocument,
                g = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== g && 9 !== g && 11 !== g) return n;
            if (!i && ((t ? t.ownerDocument || t : W) !== j && L(t), t = t || j, P)) {
                if (11 !== g && (c = ve.exec(e)))
                    if (o = c[1]) {
                        if (9 === g) {
                            if (!(s = t.getElementById(o))) return n;
                            if (s.id === o) return n.push(s), n
                        } else if (f && (s = f.getElementById(o)) && $(t, s) && s.id === o) return n.push(s), n
                    } else {
                        if (c[2]) return G.apply(n, t.getElementsByTagName(e)), n;
                        if ((o = c[3]) && b.getElementsByClassName && t.getElementsByClassName) return G.apply(n, t.getElementsByClassName(o)), n
                    }
                if (b.qsa && !X[e + " "] && (!O || !O.test(e))) {
                    if (1 !== g) f = t, p = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(we, "\\$&") : t.setAttribute("id", a = z), d = k(e), r = d.length, l = he.test(a) ? "#" + a : "[id='" + a + "']"; r--;) d[r] = l + " " + h(d[r]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, r) {
                ...
                if (s) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || o) {
                            if (c = t[z] || (t[z] = {}), l = c[t.uniqueID] || (c[t.uniqueID] = {}), (a = l[i]) && a[0] === R && a[1] === r) return u[2] = a[2];
            ...
            return o && !o[z] && (o = v(o)), r && !r[z] && (r = v(r, s)), i(function(i, s, a, l) {
                ...
                if (i) {
                    if (r || e) {
                        ...
                        for (u = w.length; u--;)(d = w[u]) && (c = r ? ee(i, d) : h[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else w = m(w === s ? w.splice(f, w.length) : w), r ? r(null, s, w, l) : G.apply(s, w)
            })
        }
            ...
            var o = n.length > 0,
                ...
                s = function(i, s, a, l, c) {
                    var u, d, h, p = 0,
                        ...
                        b = w.length;
                    for (c && (A = s === j || s || c); f !== b && null != (u = w[f]); f++) {
                        if (r && u) {
                            for (d = 0, s || u.ownerDocument === j || (L(u), a = !P); h = e[d++];)
                                if (h(u, s || j, a)) {
                                    l.push(u);
                                    break
                                }
        ...
        var x, b, C, _, T, k, E, S, A, N, D, L, j, M, P, O, H, I, $, z = "sizzle" + 1 * new Date,
            W = e.document,
            R = 0,
            q = 0,
            F = n(),
        ...
        try {
            G.apply(Z = J.call(W.childNodes), W.childNodes), Z[W.childNodes.length].nodeType
        } catch (_e) {
            G = {
        ...
        b = t.support = {}, T = t.isXML = function(e) {
            ...
            return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, M = j.documentElement, P = !T(j), (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), b.attributes = o(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), b.getElementsByTagName = o(function(e) {
                return e.appendChild(j.createComment("")), !e.getElementsByTagName("*").length
            }), b.getElementsByClassName = me.test(j.getElementsByClassName), b.getById = o(function(e) {
                return M.appendChild(e).id = z, !j.getElementsByName || !j.getElementsByName(z).length
            ...
            }, H = [], O = [], (b.qsa = me.test(j.querySelectorAll)) && (o(function(e) {
            ...
            })), (b.matchesSelector = me.test(I = M.matches || M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector)) && o(function(e) {
                b.disconnectedMatch = I.call(e, "div"), I.call(e, "[s!='']:x"), H.push("!=", re)
            }), O = O.length && new RegExp(O.join("|")), H = H.length && new RegExp(H.join("|")), t = me.test(M.compareDocumentPosition), $ = t || me.test(M.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === j || e.ownerDocument === W && $(W, e) ? -1 : t === j || t.ownerDocument === W && $(W, t) ? 1 : N ? ee(N, e) - ee(N, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return D = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== j && L(e), n = n.replace(ue, "='$1']"), b.matchesSelector && P && !X[n + " "] && (!H || !H.test(n)) && (!O || !O.test(n))) try {
                var i = I.call(e, n);
                if (i || b.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
            } catch (o) {}
            return t(n, j, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== j && L(e), $(e, t)
        }, t.attr = function(e, t) {
            (e.ownerDocument || e) !== j && L(e);
            var n = C.attrHandle[t.toLowerCase()],
                i = n && Y.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !P) : void 0;
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (D = !b.detectDuplicates, N = !b.sortStable && e.slice(0), e.sort(V), D) {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (f = [s ? m.firstChild : m.lastChild], s && y) {
                                for (h = m, d = h[z] || (h[z] = {}),
                                    u = d[h.uniqueID] || (d[h.uniqueID] = {}), c = u[e] || [], p = c[0] === R && c[1], w = p && c[2], h = p && m.childNodes[p]; h = ++p && h && h[g] || (w = p = 0) || f.pop();)
                                    if (1 === h.nodeType && ++w && h === t) {
                                        u[e] = [R, p, w];
                                        break
                                    }
                            } else if (y && (h = t, d = h[z] || (h[z] = {}), u = d[h.uniqueID] || (d[h.uniqueID] = {}), c = u[e] || [], p = c[0] === R && c[1], w = p), w === !1)
                                for (;
                                    (h = ++p && h && h[g] || (w = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++w || (y && (d = h[z] || (h[z] = {}), u = d[h.uniqueID] || (d[h.uniqueID] = {}), u[e] = [R, w]), h !== t)););
        ...
        return d.prototype = C.filters = C.pseudos, C.setFilters = new d, k = t.tokenize = function(e, n) {
            ...
            var n, i = [],
                ...
                r = X[e + " "];
            if (!r) {
                for (t || (t = k(e)), n = t.length; n--;) r = y(t[n]), r[z] ? i.push(r) : o.push(r);
            ...
            if (n = n || [], 1 === d.length) {
                if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && b.getById && 9 === t.nodeType && P && C.relative[r[1].type]) {
                ...
                for (o = pe.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !C.relative[a = s.type]);)
                    if ((l = C.find[a]) && (i = l(s.matches[0].replace(xe, be), ye.test(r[0].type) && u(t.parentNode) || t))) {
                        if (r.splice(o, 1), e = i.length && h(r), !e) return G.apply(n, i), n;
                        break
                    }
            }
            return (c || E(e, d))(i, t, !P, n, !t || ye.test(e) && u(t.parentNode) || t), n
        }, b.sortStable = z.split("").sort(V).join("") === z, b.detectDuplicates = !!D, L(), b.sortDetached = o(function(e) {
    ...
    pe.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, i = 0, o = this.length, r = [], s = be.test(e) || "string" != typeof e ? pe(e, t || this.context) : 0; o > i; i++)
        ...
        pe.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = pe.filter(i, o)), this.length > 1 && (Ae[e] || (o = pe.uniqueSort(o)), Se.test(e) && (o = o.reverse())), this.pushStack(o)
        }
    });
    var Ne = /\S+/g;
    pe.Callbacks = function(e) {
            ...
            u = {
                add: function() {
                    return s && (n && !t && (l = s.length - 1, a.push(n)), function i(t) {
                        pe.each(t, function(t, n) {
                            pe.isFunction(n) ? e.unique && u.has(n) || s.push(n) : n && n.length && "string" !== pe.type(n) && i(n)
                        })
                ...
                remove: function() {
                    return pe.each(arguments, function(e, t) {
                        for (var n;
                            (n = pe.inArray(t, s, n)) > -1;) s.splice(n, 1), l >= n && l--
                    }), this
                },
                has: function(e) {
        ...
        when: function(e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), i = new Array(s); s > o; o++) r[o] && pe.isFunction(r[o].promise) ? r[o].promise().progress(c(o, n, t)).done(c(o, i, r)).fail(l.reject) : --a;
    ...
    pe.fn.ready = function(e) {
        ...
        if (!De)
            if (De = pe.Deferred(), "complete" === ie.readyState) e.setTimeout(pe.ready);
    ...
    pe.extend({
            ...
            data: function(e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (o = pe.data(r), 1 === r.nodeType && !pe._data(r, "parsedAttrs"))) {
                        for (n = s.length; n--;) s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = pe.camelCase(i.slice(5)), l(r, i, o[i])));
            ...
            promise: function(e, t) {
                ...
                for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;) n = pe._data(r[s], e + "queueHooks"), n && n.empty && (i++, n.empty.add(a));
    ...
    pe.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, s, a, l, c, u, d, h, p, f, g, m = pe._data(e);
            if (m) {
                for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = pe.guid++), (s = m.events) || (s = m.events = {}), (u = m.handle) || (u = m.handle = function(e) {
                        return "undefined" == typeof pe || e && pe.event.triggered === e.type ? void 0 : pe.event.dispatch.apply(u.elem, arguments)
                    }, u.elem = e), t = (t || "").match(Ne) || [""], a = t.length; a--;) r = Ge.exec(t[a]) || [], p = g = r[1], f = (r[2] || "").split(".").sort(), p && (c = pe.event.special[p] || {}, p = (o ? c.delegateType : c.bindType) || p, c = pe.event.special[p] || {}, d = pe.extend({
                    type: p,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, l), (h = s[p]) || (h = s[p] = [], h.delegateCount = 0, c.setup && c.setup.call(e, i, f, u) !== !1 || (e.addEventListener ? e.addEventListener(p, u, !1) : e.attachEvent && e.attachEvent("on" + p, u))), c.add && (c.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, d) : h.push(d), pe.event.global[p] = !0);
                e = null
            }
        },
        remove: function(e, t, n, i, o) {
            var r, s, a, l, c, u, d, h, p, f, g, m = pe.hasData(e) && pe._data(e);
            if (m && (u = m.events)) {
                for (t = (t || "").match(Ne) || [""], c = t.length; c--;)
                    if (a = Ge.exec(t[c]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                        for (d = pe.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, h = u[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = h.length; r--;) s = h[r], !o && g !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (h.splice(r, 1), s.selector && h.delegateCount--, d.remove && d.remove.call(e, s));
                        l && !h.length && (d.teardown && d.teardown.call(e, f, m.handle) !== !1 || pe.removeEvent(e, p, m.handle), delete u[p])
                    } else
        ...
        trigger: function(t, n, i, o) {
            ...
            if (a = u = i = i || ie, 3 !== i.nodeType && 8 !== i.nodeType && !Ke.test(p + pe.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), s = p.indexOf(":") < 0 && "on" + p, t = t[pe.expando] ? t : new pe.Event(p, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : pe.makeArray(n, [t]), c = pe.event.special[p] || {}, o || !c.trigger || c.trigger.apply(i, n) !== !1)) {
                if (!o && !c.noBubble && !pe.isWindow(i)) {
                    for (l = c.delegateType || p, Ke.test(l + p) || (a = a.parentNode); a; a = a.parentNode) h.push(a), u = a;
                    u === (i.ownerDocument || ie) && h.push(u.defaultView || u.parentWindow || e)
                }
                for (d = 0;
                    (a = h[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? l : c.bindType || p, r = (pe._data(a, "events") || {})[t.type] && pe._data(a, "handle"), r && r.apply(a, n), r = s && a[s], r && r.apply && je(a) && (t.result = r.apply(a, n), t.result === !1 && t.preventDefault());
                if (t.type = p, !o && !t.isDefaultPrevented() && (!c._default || c._default.apply(h.pop(), n) === !1) && je(i) && s && i[p] && !pe.isWindow(i)) {
                    u = i[s], u && (i[s] = null), pe.event.triggered = p;
                    try {
                        i[p]()
                    } catch (g) {}
                    pe.event.triggered = void 0, u && (i[s] = u)
                }
                return t.result
            }
        },
            ...
            if (a[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                for (s = pe.event.handlers.call(this, e, l), t = 0;
                    ...
                    for (e.currentTarget = o.elem, n = 0;
                        (r = o.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e.rnamespace || e.rnamespace.test(r.namespace)) && (e.handleObj = r, e.data = r.data, i = ((pe.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
            ...
            if (a && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
                        for (i = [], n = 0; a > n; n++) r = t[n], o = r.selector + " ", void 0 === i[o] && (i[o] = r.needsContext ? pe(o, this).index(l) > -1 : pe.find(o, this, null, [l]).length), i[o] && i.push(r);
                        i.length && s.push({
                            elem: l,
                            handlers: i
                        })
        ...
        fix: function(e) {
            ...
            var t, n, i, o = e.type,
                r = e,
                s = this.fixHooks[o];
            for (s || (this.fixHooks[o] = s = Qe.test(o) ? this.mouseHooks : Ze.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new pe.Event(r), t = i.length; t--;) n = i[t], e[n] = r[n];
        ...
        return this instanceof pe.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? y : w) : this.type = e, t && pe.extend(this, t), this.timeStamp = e && e.timeStamp || pe.now(), void(this[pe.expando] = !0)) : new pe.Event(e, t)
    }, pe.Event.prototype = {
    ...
    pe.extend({
        ...
        clone: function(e, t, n) {
            var i, o, r, s, a, l = pe.contains(e.ownerDocument, e);
            if (de.html5Clone || pe.isXMLDoc(e) || !et.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) : (at.innerHTML = e.outerHTML, at.removeChild(r = at.firstChild)), !(de.noCloneEvent && de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e)))
                for (i = f(r), a = f(e), s = 0; null != (o = a[s]); ++s) i[s] && E(o, i[s]);
            if (t)
                if (n)
                    for (a = a || f(e), i = i || f(r), s = 0; null != (o = a[s]); s++) k(o, i[s]);
                else k(e, r);
            return i = f(r, "script"), i.length > 0 && g(i, !l && f(e, "script")), i = a = o = null, r
        },
        cleanData: function(e, t) {
            for (var n, i, o, r, s = 0, a = pe.expando, l = pe.cache, c = de.attributes, u = pe.event.special; null != (n = e[s]); s++)
        ...
        html: function(e) {
            return ze(this, function(e) {
                ...
                if ("string" == typeof e && !nt.test(e) && (de.htmlSerialize || !et.test(e)) && (de.leadingWhitespace || !Fe.test(e)) && !Xe[(Re.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        pe.fn[e] = function(e) {
            for (var n, i = 0, o = [], r = pe(e), s = r.length - 1; s >= i; i++) n = i === s ? this : this.clone(!0), pe(r[i])[t](n), se.apply(o, n.get());
    ...
    e.getComputedStyle ? (ft = function(t) {
        ...
        return n = n || ft(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== s || pe.contains(e.ownerDocument, e) || (s = pe.style(e, t)), !de.pixelMarginRight() && dt.test(s) && ut.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 === s ? s : s + ""
    }) : pt.currentStyle && (ft = function(e) {
        return e.currentStyle
    }, gt = function(e, t, n) {
        var i, o, r, s, a = e.style;
        return n = n || ft(e), s = n ? n[t] : void 0, null == s && a && a[t] && (s = a[t]), dt.test(s) && !mt.test(t) && (i = a.left, o = e.runtimeStyle, r = o && o.left, r && (o.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em" : s, s = a.pixelLeft + "px", a.left = i, r && (o.left = r)), void 0 === s ? s : s + "" || "auto"
    });
    var vt = /alpha\([^)]*\)/i,
        yt = /opacity\s*=\s*([^)]*)/i,
        wt = /^(none|table(?!-c[ea]).+)/,
    ...
    pe.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = pe.camelCase(t),
                    l = e.style;
                if (t = pe.cssProps[a] || (pe.cssProps[a] = j(a) || a), s = pe.cssHooks[t] || pe.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : l[t];
                if (r = typeof n, "string" === r && (o = He.exec(n)) && o[1] && (n = h(e, t, o), r = "number"), null != n && n === n && ("number" === r && (n += o && o[3] || (pe.cssNumber[a] ? "" : "px")), de.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(s && "set" in s && void 0 === (n = s.set(e, n, i))))) try {
                    l[t] = n
                } catch (c) {}
            }
        },
        css: function(e, t, n, i) {
            var o, r, s, a = pe.camelCase(t);
            return t = pe.cssProps[a] || (pe.cssProps[a] = j(a) || a), s = pe.cssHooks[t] || pe.cssHooks[a], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = gt(e, t, i)), "normal" === r && t in Ct && (r = Ct[t]), "" === n || n ? (o = parseFloat(r), n === !0 || isFinite(o) ? o || 0 : r) : r
        }
    }), pe.each(["height", "width"], function(e, t) {
        pe.cssHooks[t] = {
            get: function(e, n, i) {
                return n ? wt.test(pe.css(e, "display")) && 0 === e.offsetWidth ? ht(e, bt, function() {
                    return H(e, t, i)
                }) : H(e, t, i) : void 0
            },
            set: function(e, n, i) {
                var o = i && ft(e);
                return P(e, n, i ? O(e, t, i, de.boxSizing && "border-box" === pe.css(e, "boxSizing", !1, o), o) : 0)
            }
        }
        ...
        return t ? (parseFloat(gt(e, "marginLeft")) || (pe.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - ht(e, {
            marginLeft: 0
        }, function() {
        ...
        }, ut.test(e) || (pe.cssHooks[e + t].set = P)
    }), pe.fn.extend({
        css: function(e, t) {
            return ze(this, function(e, t, n) {
                var i, o, r = {},
                    s = 0;
                if (pe.isArray(t)) {
                    for (i = ft(e), o = t.length; o > s; s++) r[t[s]] = pe.css(e, t[s], !1, i);
                    return r
                }
    ...
    pe.fn.extend({
        val: function(e) {
            ...
            })) : o ? (t = pe.valHooks[o.type] || pe.valHooks[o.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(Nt, "") : null == n ? "" : n)) : void 0
        }
    }), pe.extend({
        valHooks: {
            option: {
            ...
            select: {
                get: function(e) {
                    for (var t, n, i = e.options, o = e.selectedIndex, r = "select-one" === e.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)
                        if (n = i[l], (n.selected || l === o) && (de.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !pe.nodeName(n.parentNode, "optgroup"))) {
                ...
                set: function(e, t) {
                    for (var n, i, o = e.options, r = pe.makeArray(t), s = o.length; s--;)
                        if (i = o[s], pe.inArray(pe.valHooks.option.get(i), r) >= 0) try {
                            i.selected = n = !0
                        } catch (a) {
                            i.scrollHeight
                        } else i.selected = !1;
    ...
    pe.fn.extend({
        ...
        removeAttr: function(e, t) {
            var n, i, o = 0,
                r = t && t.match(Ne);
            if (r && 1 === e.nodeType)
                for (; n = r[o++];) i = pe.propFix[n] || n, pe.expr.match.bool.test(n) ? Ot && Pt || !Mt.test(n) ? e[i] = !1 : e[pe.camelCase("default-" + n)] = e[i] = !1 : pe.attr(e, n, ""), e.removeAttribute(Pt ? n : i)
        }
    }), Lt = {
        set: function(e, t, n) {
            return t === !1 ? pe.removeAttr(e, n) : Ot && Pt || !Mt.test(n) ? e.setAttribute(!Pt && pe.propFix[n] || n, n) : e[pe.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, pe.each(pe.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var n = jt[t] || pe.find.attr;
        Ot && Pt || !Mt.test(t) ? jt[t] = function(e, t, i) {
            var o, r;
        ...
        propHooks: {
            tabIndex: {
                get: function(e) {
                    ...
                    return t ? parseInt(t, 10) : Ht.test(e.nodeName) || It.test(e.nodeName) && e.href ? 0 : -1
                }
            }
        },
        propFix: {
    ...
    pe.fn.extend({
        addClass: function(e) {
            ...
            if ("string" == typeof e && e)
                for (t = e.match(Ne) || []; n = this[l++];)
                    if (o = B(n), i = 1 === n.nodeType && (" " + o + " ").replace($t, " ")) {
                        for (s = 0; r = t[s++];) i.indexOf(" " + r + " ") < 0 && (i += r + " ");
                        a = pe.trim(i), o !== a && pe.attr(n, "class", a)
                    }
            return this
        },
        ...
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && (" " + B(n) + " ").replace($t, " ").indexOf(t) > -1) return !0;
            return !1
        }
    ...
    pe.parseJSON = function(t) {
        ...
        var n, i = null,
            o = pe.trim(t + "");
        return o && !pe.trim(o.replace(qt, function(e, t, o, r) {
    ...
    pe.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, o) {
                var r, d, y, w, b, _ = n;
                2 !== x && (x = 2, l && e.clearTimeout(l), u = void 0, a = o || "", C.readyState = t > 0 ? 4 : 0, r = t >= 200 && 300 > t || 304 === t, i && (w = Y(h, C, i)), w = Z(h, w, C, r), r ? (h.ifModified && (b = C.getResponseHeader("Last-Modified"), b && (pe.lastModified[s] = b), b = C.getResponseHeader("etag"), b && (pe.etag[s] = b)), 204 === t || "HEAD" === h.type ? _ = "nocontent" : 304 === t ? _ = "notmodified" : (_ = w.state, d = w.data, y = w.error, r = !y)) : (y = _, (t || !_) && (_ = "error", 0 > t && (t = 0))), C.status = t, C.statusText = (n || _) + "", r ? g.resolveWith(p, [d, _, C]) : g.rejectWith(p, [C, _, y]), C.statusCode(v), v = void 0, c && f.trigger(r ? "ajaxSuccess" : "ajaxError", [C, h, r ? d : y]), m.fireWith(p, [C, _]), c && (f.trigger("ajaxComplete", [C, h]), --pe.active || pe.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var o, r, s, a, l, c, u, d, h = pe.ajaxSetup({}, n),
                p = h.context || h,
                ...
                C = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (2 === x) {
                            if (!d)
                                for (d = {}; t = Xt.exec(a);) d[t[1].toLowerCase()] = t[2];
                            t = d[e.toLowerCase()]
                        }
            ...
            if (g.promise(C).complete = m.add, C.success = C.done, C.error = C.fail, h.url = ((t || h.url || Jt) + "").replace(Ft, "").replace(Yt, en[1] + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = pe.trim(h.dataType || "*").toLowerCase().match(Ne) || [""], null == h.crossDomain && (o = Zt.exec(h.url.toLowerCase()), h.crossDomain = !(!o || o[1] === en[1] && o[2] === en[2] && (o[3] || ("http:" === o[1] ? "80" : "443")) === (en[3] || ("http:" === en[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = pe.param(h.data, h.traditional)), V(Qt, h, n, C), 2 === x) return C;
            c = pe.event && h.global, c && 0 === pe.active++ && pe.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ut.test(h.type), s = h.url, h.hasContent || (h.data && (s = h.url += (Rt.test(s) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (h.url = Bt.test(s) ? s.replace(Bt, "$1_=" + Wt++) : s + (Rt.test(s) ? "&" : "?") + "_=" + Wt++)), h.ifModified && (pe.lastModified[s] && C.setRequestHeader("If-Modified-Since", pe.lastModified[s]), pe.etag[s] && C.setRequestHeader("If-None-Match", pe.etag[s])), (h.data && h.hasContent && h.contentType !== !1 || n.contentType) && C.setRequestHeader("Content-Type", h.contentType), C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Gt + "; q=0.01" : "") : h.accepts["*"]);
            ...
            if (u = V(Kt, h, n, C)) {
                if (C.readyState = 1, c && f.trigger("ajaxSend", [C, h]), 2 === x) return C;
    ...
    pe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && sn.test(this.nodeName) && !rn.test(e) && (this.checked || !We.test(e))
            }).map(function(e, t) {
                var n = pe(this).val();
                ...
                send: function(i, o) {
                    ...
                    s.send(t.hasContent && t.data || null), n = function(e, i) {
                        ...
                        if (n && (i || 4 === s.readyState))
                            if (delete ln[a], n = void 0, s.onreadystatechange = pe.noop, i) 4 !== s.readyState && s.abort();
                            else {
    ...
    pe.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (o = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(dn, "$1" + o) : t.jsonp !== !1 && (t.url += (Rt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
            return s || pe.error(o + " was not called"), s[0]
        }, t.dataTypes[0] = "json", r = e[o], e[o] = function() {
            s = arguments
        }, i.always(function() {
            void 0 === r ? pe(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, un.push(o)), s && pe.isFunction(r) && r(s[0]), s = r = void 0
        }), "script") : void 0
    ...
    pe.fn.load = function(e, t, n) {
        ...
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return a > -1 && (i = pe.trim(e.slice(a, e.length)), e = e.slice(0, a)), pe.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && pe.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, o, r, s, a, l, c, u = pe.css(e, "position"),
                d = pe(e),
                h = {};
            "static" === u && (e.style.position = "relative"), a = d.offset(), r = pe.css(e, "top"), l = pe.css(e, "left"), c = ("absolute" === u || "fixed" === u) && pe.inArray("auto", [r, l]) > -1, c ? (i = d.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), pe.isFunction(t) && (t = t.call(e, n, pe.extend({}, a))), null != t.top && (h.top = t.top - a.top + s), null != t.left && (h.left = t.left - a.left + o), "using" in t ? t.using.call(e, h) : d.css(h)
        }
    }, pe.fn.extend({
        offset: function(e) {
            ...
            var t, n, i = {
                ...
                o = this[0],
                r = o && o.ownerDocument;
            return r ? (t = r.documentElement, pe.contains(t, o) ? ("undefined" != typeof o.getBoundingClientRect && (i = o.getBoundingClientRect()), n = te(r), {
        ...
        pe.each({
            ...
            pe.fn[i] = function(i, o) {
                ...
                return ze(this, function(t, n, i) {
                    var o;
                    return pe.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (o = t.documentElement, Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === i ? pe.css(t, n, s) : pe.style(t, n, i, s)
                }, t, r ? i : void 0, r, null)
            }
        })
    }), pe.fn.extend({
...
function(e, t, n, i) {
    ...
    n.extend(a, {
        ...
        next: function(e) {
            var t = a.current;
            t && (h(e) || (e = t.direction.next), a.jumpto(t.index + 1, e, "Próxima"))
        },
        prev: function(e) {
            var t = a.current;
            t && (h(e) || (e = t.direction.prev), a.jumpto(t.index - 1, e, "Anterior"))
        },
        jumpto: function(e, t, n) {
            var o = a.current;
            o && (e = g(e), a.direction = t || o.direction[e >= o.index ? "next" : "prev"], a.router = n || "jumpto", o.loop && (e < 0 && (e = o.group.length + e % o.group.length), e %= o.group.length), o.group[e] !== i && (a.cancel(), a._start(e)))
        },
        ...
        bindEvents: function() {
            ...
            t && (r.bind("orientationchange.fb" + (u ? "" : " resize.fb") + (t.autoCenter && !t.locked ? " scroll.fb" : ""), a.update), e = t.keys, e && s.bind("keydown.fb", function(o) {
                ...
                for (var s = e.target || null, l = n(s), c = !1; l.length && !(c || l.is(".fancybox-skin") || l.is(".fancybox-wrap"));) c = f(l[0]), l = n(l).parent();
        ...
        _setDimension: function() {
            var e, t, i, o, r, s, l, c, u, d, h, f, v, y, w, x = a.getViewport(),
                b = 0,
                C = !1,
                _ = !1,
                T = a.wrap,
                ...
                M = S.maxHeight,
                P = S.scrolling,
                O = S.scrollOutside ? S.scrollbarWidth : 0,
                H = S.margin,
                I = g(H[1] + H[3]),
                $ = g(H[0] + H[2]);
            if (T.add(k).add(E).width("auto").height("auto").removeClass("fancybox-tmp"), e = g(k.outerWidth(!0) - k.width()), t = g(k.outerHeight(!0) - k.height()), i = I + e, o = $ + t, r = p(A) ? (x.w - i) * g(A) / 100 : A, s = p(N) ? (x.h - o) * g(N) / 100 : N, "iframe" === S.type) {
                if (y = S.content, S.autoHeight && 1 === y.data("ready")) try {
                    y[0].contentWindow.document.location && (E.width(r).height(9999), w = y.contents().find("body"), O && w.css("overflow-x", "hidden"), s = w.outerHeight(!0))
                } catch (z) {}
            ...
            if (A = g(r), N = g(s), u = r / s, D = g(p(D) ? g(D, "w") - i : D), j = g(p(j) ? g(j, "w") - i : j), L = g(p(L) ? g(L, "h") - o : L), M = g(p(M) ? g(M, "h") - o : M), l = j, c = M, S.fitToView && (j = Math.min(x.w - i, j), M = Math.min(x.h - o, M)), f = x.w - I, v = x.h - $, S.aspectRatio ? (A > j && (A = j, N = g(A / u)), N > M && (N = M, A = g(N * u)), A < D && (A = D, N = g(A / u)), N < L && (N = L, A = g(N * u))) : (A = Math.max(D, Math.min(A, j)), S.autoHeight && "iframe" !== S.type && (E.width(A), N = E.height()), N = Math.max(L, Math.min(N, M))), S.fitToView)
                if (E.width(A).height(N), T.width(A + e), d = T.width(), h = T.height(), S.aspectRatio)
                    for (;
                        (d > f || h > v) && A > D && N > L && !(b++ > 19);) N = Math.max(L, Math.min(M, N - 10)), A = g(N * u), A < D && (A = D, N = g(A / u)), A > j && (A = j, N = g(A / u)), E.width(A).height(N), T.width(A + e), d = T.width(), h = T.height();
                else A = Math.max(D, Math.min(A, A - (d - f))), N = Math.max(L, Math.min(N, N - (h - v)));
            O && "auto" === P && N < s && A + e + O < f && (A += O), E.width(A).height(N), T.width(A + e), d = T.width(), h = T.height(), C = (d > f || h > v) && A > D && N > L, _ = S.aspectRatio ? A < l && N < c && A < r && N < s : (A < l || N < c) && (A < r || N < s), n.extend(S, {
                dim: {
                    width: m(d),
                    height: m(h)
                },
                ...
                skinSpace: k.height() - N
            }), !y && S.autoHeight && N > L && N < M && !_ && E.height("auto")
        },
...
function(e) {
    ...
    w.prototype = {
        ...
        open: function(n) {
            ...
            t.types = [], r = "", n.mainEl && n.mainEl.length ? t.ev = n.mainEl.eq(0) : t.ev = i, n.key ? (t.popupsCache[n.key] || (t.popupsCache[n.key] = {}), t.currTemplate = t.popupsCache[n.key]) : t.currTemplate = {}, t.st = e.extend(!0, {}, e.magnificPopup.defaults, n), t.fixedContentPos = "auto" === t.st.fixedContentPos ? !t.probablyMobile : t.st.fixedContentPos, t.st.modal && (t.st.closeOnContentClick = !1, t.st.closeOnBgClick = !1, t.st.showCloseBtn = !1, t.st.enableEscapeKey = !1), t.bgOverlay || (t.bgOverlay = _("bg").on("click" + g, function() {
                t.close()
            }), t.wrap = _("wrap").attr("tabindex", -1).on("click" + g, function(e) {
            ...
            T("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (C(d, function(e, t, n, i) {
            ...
            }, 16), t.isOpen = !0, t.updateSize(u), T(h), n
        },
        close: function() {
        ...
        updateItemHTML: function() {
            ...
            t.appendContent(s, i), n.preloaded = !0, T(p, n), o = n.type, t.container.prepend(t.contentContainer), T("AfterChange")
        },
        ...
        _openClick: function(n, i, o) {
            ...
            if (r || !(2 === n.which || n.ctrlKey || n.metaKey || n.altKey || n.shiftKey)) {
                ...
                n.type && (n.preventDefault(), t.isOpen && n.stopPropagation()), o.el = e(n.mfpEl), o.delegate && (o.items = i.find(o.delegate)),
                    t.open(o)
            }
        },
        ...
        _parseMarkup: function(t, n, i) {
            var o;
            i.data && (n = e.extend(i.data, n)), T(d, [t, n, i]), e.each(n, function(e, n) {
    ...
    var A, N, D, L = "inline",
        j = function() {
            D && (N.after(D.addClass(A)).detach(), D = null)
        };
            ...
            getInline: function(n, i) {
                if (j(), n.src) {
                    ...
                    if (r.length) {
                        ...
                        s && s.tagName && (N || (A = o.hiddenClass, N = _(A), A = "mfp-" + A), D = r.after(N).detach().removeClass(A)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(P, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(P), M = t.st.ajax.cursor, C(a + "." + P, H), C("BeforeChange." + P, H)
            },
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, o, r) {
                        ...
                        T("ParseAjax", s), t.appendContent(e(s.data), P), n.finished = !0, O(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(m)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
                ...
                var n = 0,
                    ...
                    o = function(r) {
                        I && clearInterval(I), I = setInterval(function() {
                            return i.naturalWidth > 0 ? void t._onImageHasSize(e) : (n > 200 && clearInterval(I), n++, void(3 === n ? o(10) : 40 === n ? o(50) : 100 === n && o(500)))
                        }, r)
                    };
                o(1)
            },
            getImage: function(n, i) {
                var o = 0,
                    r = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, T("ImageLoadComplete")) : (o++, o < 200 ? setTimeout(r, 100) : s()))
                    },
                    s = function() {
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(n) {
                ...
                var a = {
                    width: i.width(),
                    height: (x ? i.innerHeight() : i[0].offsetHeight) - s - r
                };
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                return t.direction = !0, !(!n || !n.enabled) && (r += " mfp-gallery", C(h + o, function() {
                    ...
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        ...
                        o[a](function() {
                            ...
                            t.next()
                        }), t.isIE7 && (_("b", o[0], !1, !0), _("a", o[0], !1, !0), _("b", r[0], !1, !0), _("a", r[0], !1, !0)), t.container.append(o.add(r))
                    }
                }), C(p + o, function() {
                    ...
                    i.off(o), t.wrap.off("click" + o), t.arrowLeft && s && t.arrowLeft.add(t.arrowRight).destroyMfpFastClick(), t.arrowRight = t.arrowLeft = null
                }))
            },
            next: function() {
                ...
                return e(this).each(function() {
                    ...
                    if (n) {
                        ...
                        a.on("touchstart" + r, function(e) {
                            d = !1, p = 1, h = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0], c = h.clientX, u = h.clientY, b.on("touchmove" + r, function(e) {
...
function(e) {
    ...
    e.mask = {
        ...
        mask: function(t, o) {
            var a, l, c, u, d, h;
            return !t && this.length > 0 ? (a = e(this[0]), a.data(e.mask.dataName)()) : (o = e.extend({
                placeholder: e.mask.placeholder,
                completed: null
            }, o), l = e.mask.definitions, c = [], u = h = t.length, d = null, e.each(t.split(""), function(e, t) {
                "?" == t ? (h--, u = e) : l[t] ? (c.push(RegExp(l[t])), null === d && (d = c.length - 1)) : c.push(null)
                ...
                function f(e, t) {
                    ...
                    if (!(0 > e)) {
                        for (n = e, i = a(t); h > n; n++)
                            if (c[n]) {
                                if (!(h > i && c[n].test(C[i]))) break;
                                C[n] = C[i], C[i] = o.placeholder, i = a(i)
                            }
                        w(), b.caret(Math.max(d, e))
                    }
                }

                function g(e) {
                    var t, n, i, r;
                    for (t = e, n = o.placeholder; h > t; t++)
                        if (c[t]) {
                            if (i = a(t), r = C[t], C[t] = n, !(h > i && c[i].test(r))) break;
                            n = r
                        }
                }
                ...
                function m(e) {
                    var t, n, i, o = e.which;
                    8 === o || 46 === o || r && 127 === o ? (t = b.caret(), n = t.begin, i = t.end, 0 === i - n && (n = 46 !== o ? p(n) : i = a(n - 1), i = 46 === o ? a(i) : i), y(n, i), f(n, i - 1), e.preventDefault()) : 27 == o && (b.val(_), b.caret(0, x()), e.preventDefault())
                }

                function v(t) {
                    var n, i, r, l = t.which,
                        u = b.caret();
                    t.ctrlKey || t.altKey || t.metaKey || 32 > l || l && (0 !== u.end - u.begin && (y(u.begin, u.end), f(u.begin, u.end - 1)), n = a(u.begin - 1), h > n && (i = String.fromCharCode(l), c[n].test(i) && (g(n), C[n] = i, w(), r = a(n), s ? setTimeout(e.proxy(e.fn.caret, b, r), 0) : b.caret(r), o.completed && r >= h && o.completed.call(b))), t.preventDefault())
                }

                function y(e, t) {
                    var n;
                    for (n = e; t > n && h > n; n++) c[n] && (C[n] = o.placeholder)
                }
                ...
                function x(e) {
                    ...
                    for (t = 0, pos = 0; h > t; t++)
                        if (c[t]) {
                            for (C[t] = o.placeholder; pos++ < i.length;)
                                if (n = i.charAt(pos - 1), c[t].test(n)) {
                                    C[t] = n, r = t;
                                    break
                                }
                            if (pos > i.length) break
                        } else C[t] === i.charAt(pos) && t !== u && (pos++, r = t);
                    return e ? w() : u > r + 1 ? (b.val(""), y(0, h)) : (w(), b.val(b.val().substring(0, r + 1))), u ? t : d
                }
                var b = e(this),
                    C = e.map(t.split(""), function(e) {
                        return "?" != e ? l[e] ? o.placeholder : e : void 0
                    }),
                    _ = b.val();
                b.data(e.mask.dataName, function() {
                    return e.map(C, function(e, t) {
                        return c[t] && e != o.placeholder ? e : null
                    }).join("")
                    ...
                    clearTimeout(n);
                    var e;
                    _ = b.val(), e = x(), n = setTimeout(function() {
                        w(), e == t.length ? b.caret(0, e) : b.caret(e)
                    }, 10)
                    ...
                    setTimeout(function() {
                        var e = x(!0);
                        b.caret(e), o.completed && e == b.val().length && o.completed.call(b)
                    }, 0)
                }), x()
            }))
        }
        ...
        (document.body.classList.contains("page-template-page-institucional") || document.body.classList.contains("page-template-page-institucional-en")) && e(window).load(function() {
            function e() {
                var e, n, i, o, r, s, a = [{
                    ...
                    l = document.getElementById("wrap-mapa"),
                    c = l.getElementsByTagName("*"),
                    u = new google.maps.Map(document.getElementById("map"), {
                        zoom: 6,
                        scrollwheel: !1,
                        center: {
                            lat: +c[0].getAttribute("data-lat"),
                            lng: +c[0].getAttribute("data-long")
                        },
                        styles: a
                    }),
                    ...
                    p = [];
                for (e = 0; e < c.length; ++e) n = c[e], i = n.getAttribute("data-info"), o = n.getAttribute("data-lat"), r = n.getAttribute("data-long"), s = n.getAttribute("data-content"), icone = n.getAttribute("data-icone"), p.push([i, o, r, s, icone]);
                t(u, p, d, h), u.fitBounds(h);
                var f = google.maps.event.addListener(u, "idle", function() {
                    u.getZoom() > 16 && u.setZoom(16), google.maps.event.removeListener(f)
                })
            }
            ...
            function t(e, t, n, i) {
                ...
                for (r = 0; r < t.length; r++) {
                    ...
                    e.setCenter(o.getPosition());
                    var c = "<div class='maps'><h4 class='maps__titulo'>" + s + "</h4><p>" + c + "</p></div>";
                    google.maps.event.addListener(o, "click", function(t, n, i) {
                        return function() {
                            i.close(), i.setContent(n), i.open(e, t)
                        }
                    }(o, c, n))
                }
            }
        ...
        function s(e) {
            var t, i, o = n.createElement("div"),
                r = e;
            for (t in r)
                if (i = r[t], "undefined" != typeof o.style[i]) return o = null, [i, t];
            return [!1]
        }
        ...
        h = {
            ...
            run: function() {
                ...
                if (this.$stage.css(o), o = {
                    ...
                    for (t = 0, n = this._coordinates.length; n > t; t++) o.width = Math.abs(this._coordinates[t]) - Math.abs(this._coordinates[t - 1] || 0) - this.settings.margin, this.$stage.children().eq(t).css(o);
            ...
            this._core = t, this._loaded = [], this._handlers = {
                "initialized.owl.carousel change.owl.carousel": e.proxy(function(t) {
                    if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                        for (var n = this._core.settings, i = n.center && Math.ceil(n.items / 2) || n.items, o = n.center && -1 * i || 0, r = (t.property && t.property.value || this._core.current()) + o, s = this._core.clones().length, a = e.proxy(function(e, t) {
                                this.load(t)
    ...
    function(e) {
        ...
        t.Defaults = {
            ...
            if ("page" !== i.slideBy && (i.slideBy = Math.min(i.slideBy, i.items)), i.dots || "page" == i.slideBy)
                for (this._pages = [], e = o, t = 0, n = 0; r > e; e++)(t >= s || 0 === t) && (this._pages.push({
                    start: e - o,
                    end: e - o + s - 1
    ...
    function(e, t) {
        ...
        function s(e) {
            var t = !(arguments.length <= 1 || void 0 === arguments[1]) && arguments[1],
                ...
                o = void 0;
            return null != document.createEvent ? (o = document.createEvent("CustomEvent"), o.initCustomEvent(e, t, n, i)) : null != document.createEventObject ? (o = document.createEventObject(), o.eventType = e) : o.eventName = e, o
        }
        ...
        var d, h, p = function() {
            ...
            g = window.MutationObserver || window.WebkitMutationObserver || window.MozMutationObserver || (h = d = function() {
                function e() {
            ...
            m = window.getComputedStyle || function(e) {
                var t = /(\-([a-z]){1})/g;
                return {
            ...
            v = function() {
                function e() {
                    ...
                    }(), this.vendors = ["moz", "webkit"], this.start = this.start.bind(this), this.resetAnimation = this.resetAnimation.bind(this), this.scrollHandler = this.scrollHandler.bind(this), this.scrollCallback = this.scrollCallback.bind(this), this.scrolled = !0, this.config = o(t, this.defaults), null != t.scrollContainer && (this.config.scrollContainer = document.querySelector(t.scrollContainer)), this.animationNameCache = new f, this.wowEvent = s(this.config.boxClass)
                }
                return p(e, [{
                    key: "init",
                    value: function() {
                    ...
                    key: "vendorCSS",
                    value: function(e, t) {
                        for (var n = m(e), i = n.getPropertyCSSValue(t), o = 0; o < this.vendors.length; o++) {
                            var r = this.vendors[o];
                    ...
                    value: function(e) {
                        var t = e.getAttribute("data-wow-offset") || this.config.offset,
                            ...
                            i = n + Math.min(this.element.clientHeight, u()) - t,
                            o = this.offsetTop(e),
                            r = o + e.clientHeight;
                        return i >= o && r >= n
                    }
        ...
        e(document).ready(function() {
            /*function t() {
                e(window).width() > 767 && (e(".item").removeClass("owl-carousel owl-theme owl-loaded owl-hidden"), e(".item").removeAttr("id", "portfolio"))
            }

            function n() {
                e(window).width() <= 767 && (i(), o())
            }*/

            /*function i() {
                e("#portfolio").owlCarousel({
                    items: 1,
                    nav: !1,
                    dots: !1,
                    navText: !1,
            ...
            }), e(".header__toggle").click(function(t) {
                t.preventDefault(), e(this).hasClass("on") ? (e(this).removeClass("on"), e(".menu").stop().fadeOut()) : (e(this).addClass("on"), e(".menu").stop().fadeIn())
            });
            var r = e(window).height(),
                s = e(".header .banner .banner__layer").height(),
                a = r - s;
            e(".header .banner  .banner__layer").css({
                height: a + "vh"
            }),  e(window).scroll(function() {
                var e = jQuery(window).scrollTop();
                e > 0 ? (jQuery(".header").addClass("scrollOn"), jQuery(".header").removeClass("scrollOff")) : (jQuery(".header").removeClass("scrollOn"), jQuery(".header").addClass("scrollOff"))
            }), e(window).resize(function() {
                t(), n()
            }),

            
                e("#portfolio-owl").owlCarousel({
                    items: 1,
                    nav: !1,
                    dots: !0,
                    navText: !1,
...
//Checa se a barra de rolagem está acionada para então adicionar a classe scrollOn n o header 
    if (jQuery(this).scrollTop() > 0) {
            jQuery('header.header').addClass('scrollOn sticky');
    }
     
    // scroll body to 0px on click
    jQuery('#scroll-to-up').click(function () {
...
//Aplica a animação no scroll mediante clique no menu
    jQuery("#menu-scroll-nav .menu-item a, .scrollDown").click(function(event){        
        event.preventDefault();

        if( jQuery(this).attr('href') == 'http://www.i9me.com.br/orcamento/') {
            window.location.replace("http://www.i9me.com.br/orcamento/");
        }
        
        jQuery('html,body').animate({scrollTop:jQuery(this.hash).offset().top - 85}, 1000);
        
        var varHash = jQuery(this).attr('href');
